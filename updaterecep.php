...
exit;
  ...
  include "conn.php";
  $id = $_GET['id'];
  $sqli = "SELECT * FROM receptionist WHERE id = $id";
 ...
 <html lang="en">
   ...
   <body class="create-bg justify-content-center align-items-center d-flex" >
       ...
       <?php while ($row = mysqli_fetch_assoc($result)) {
          ?>
          <div class="form" >
            <h3 class="text-center" style="color:#1dbdd4;">Update Receptionist</h3>
            <form action="updatereceptionistquery.php" method="post">
               <div class="mb-3">
               ...
               <div class="mb-3">
                 ...
                 <input type="text" class="form-control" name="dept" value="<?php echo $row['dep'] ?>">
               </div>
               <div class="mb-3">
