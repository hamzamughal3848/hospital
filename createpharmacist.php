...
exit;
  ...
  if(isset($_POST['Accept'])){
    ...
    $role = $_POST['role'];
    include 'conn.php';
    $sql = "INSERT INTO pharmacist(name,dept,role,password,date) value('$name','$dep','$role','$password','$date')";
     ...
     <div class="form">
       ...
       <form action="createpharmacist.php" method="post">
          ...
          <div class="role">
            ...
            <input type="text" name="role" value="pharmacist">
          </div>
          <div class="mb-3">
